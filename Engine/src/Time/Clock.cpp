...
namespace Time {
	...
	Clock::Clock(unsigned char samples, double smoothFactor)
	{
	...
	double Clock::SmoothDelta()
	{
		return localStack.smoothDelta;
	}
	double Clock::SamplesPerSecond()
	{
	...
	void Clock::Throttle(double targetHz)
	{
